-- Visible active or archived Percent media may be signed anonymously while the bucket
-- remains private. Listing, draft reads and all writes stay unavailable.
begin;
