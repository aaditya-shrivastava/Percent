...
export interface ProductReview { id: string; rating: number; title?: string; customerName: string; text: string; date: string; images?: ProductImage[]; status: 'published' | 'pending' | 'rejected' }
