...
let website={managed:false,document:fallbackWebsiteDocument()}
...
export function StorefrontBootstrap({children}:{children:ReactNode}) {
  ...
  if(current==='ready')return <WebsiteContentProvider value={website}>{children}</WebsiteContentProvider>
