 ...
 return <>
  ...
  <div className="order-detail-grid">
   ...
   <aside>
    ...
    <section className="admin-panel order-section"><header><MapPin/><div><h2>Delivery Address</h2><p>Immutable order snapshot</p></div></header>{address?<address>{address.full_name}<br/>{address.address_line1}<br/>{address.address_line2&&<>{address.address_line2}<br/></>}{address.city}, {address.state} {address.pin_code}<br/>{address.country}</address>:<p>Shipping address unavailable.</p>}</section>
