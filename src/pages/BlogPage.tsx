...
export function BlogPage() {
  ...
  return <main className="journal-page">
    ...
    {featuredBlogArticle && <section className="journal-featured" aria-labelledby="featured-story-title">
    ...
    <section className="journal-latest" aria-labelledby="latest-stories-title">
      ...
      <small className="journal-demo-note">Published stories from Percent.</small>
    </section>
